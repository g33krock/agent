      ...
      <Container>
        {this.state.agent &&
          this.state.agent.map((ag) => (
            <Row  className="cont" key={ag.toString()}>
              <Col style={{ margin: "10px" }} >
                <h2 style={{color: ag.textColor, marginTop: "10%", textShadow: "1px 1px black"}}>
                  Meet Your MPI®
                  <br />
                  Certified Advisor
                </h2>
                    ...
                    this.state.addAgents.map((aag) => (
                      <div key={aag.image}>
                        <img
                          ...
                          alt={aag.firstName}
                        />
                          <h3 style={{color: ag.textColor}}>{aag.firstName} {aag.lastName}</h3>
